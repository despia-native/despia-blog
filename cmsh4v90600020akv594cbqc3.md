...
That license includes 200 cloud credits, which is 40 native builds, plus unlimited over-the-air updates with no MAU metering. Additional builds come in packs of 10 for $25. A build is a build: it is not metered by the minute, so a slow one costs the same as a fast one and there is no per-minute overage to model. There is no plan, no renewal, and no line that scales with how many people open your app.
...
A native plugin change, meaning a new capability, a different push provider, or a new icon, is a toggle in the dashboard and one build. That build comes out of a $25 pack of 10, against $50 to $200 on the other route.
...
Assumptions: one app on both stores, 1,000 MAU, six web releases a year, two mandatory native compliance rebuilds a year, Capgo Solo at the annual rate. Freelancer pricing taken at the middle of each range above: $600 for initial setup, $300 a year for OS compliance maintenance, and one native plugin change a year at $125. That is $425 a year in developer time, which is a conservative read of a $150 to $500 maintenance band plus $50 to $200 per native change.

|  | Despia | Capacitor, you own the native project | Capacitor, you hire it out |
| --- | --- | --- | --- |
| Year 1 | $622 | $270 | $870 |
| 5 years | $1,018 | $1,250 | $3,550 |
| 10 years | $1,613 | $2,475 | $6,900 |
| Recurring per year after setup | $99 store fee, plus a $25 build pack roughly once a year after year 5 | $245 | $670 |
...
**Despia's cost is front-loaded and then almost flat.** After the license, the recurring line is the $99 Apple fee that every route pays, plus a $25 pack of 10 builds roughly once a year, once the included 40 are gone.
